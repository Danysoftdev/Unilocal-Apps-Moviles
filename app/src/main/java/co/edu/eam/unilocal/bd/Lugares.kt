...
object Lugares {
    ...
    init {
        ...
        val lugar1 = Lugar(1, "Café ABC", "Excelente café para compartir", 1, Estado.PENDIENTE, 2, "calle 123", Posicion(4.5459369, -75.6727394), 1,"asd")
        lugar1.horarios.add(horario2)

        val lugar2 = Lugar(2, "Bar City Pub", "Bar en la ciudad de Armenia", 2, Estado.APROBADO, 5, "calle 456", Posicion(4.5485738, -75.6621022), 1,"asd")
        lugar2.horarios.add(horario1)

        val lugar3 = Lugar(3, "Restaurante Mi Cuate", "Comida mexicana para todos", 3, Estado.PENDIENTE, 3, "calle 789", Posicion(5.0652081, -75.5069207), 5,"asd")
        lugar3.horarios.add(horario1)

        val lugar4 = Lugar(4, "BBC Norte Pub", "Cervezas BBC muy buenas", 1, Estado.APROBADO, 5, "calle 147", Posicion(4.8182712, -75.7084954), 3,"asd")
        lugar4.horarios.add(horario3)

        val lugar5 = Lugar(5, "Hotel Barato", "Hotel para ahorrar mucho dinero", 1, Estado.APROBADO, 1, "calle 258", Posicion(4.5288265, -75.6398322), 4,"asd")
        lugar5.horarios.add(horario1)

        val lugar6 = Lugar(1, "Hostal Hippie", "Alojamiento para todos y todas", 2, Estado.RECHAZADO, 1, "calle 369", Posicion(4.6387454, -75.5745911), 2,"asd")
    ...
    fun ordenarPorCorazones(): ArrayList<Lugar> {
        val lugaresActivos = lugares.filter { it.estado.name ==  "APROBADO" }
